                ...
                try{
                    ...
                    if (!tabMainMenuOnHomePage.isDisable()){
                        try{
                            ...
                            //mainMenuOnHomePageTest.checkingMainMenuIndex(webDriver,report,js,mainMenuOnHomePageController.MainMenuLinkIndex,statusInfo,inputSearch, TestCases.Homepage);
                    ...
                    if (!tabFavoritePage.isDisable() & inputAccountEmail.getText() != null & !inputAccountEmail.getText().equals("") & inputAccountEmail.getText().toLowerCase().contains("@visual-meta.com") ){
                        try{
                            ...
                            favoritePageTest.checkingAddingToList(webDriver,report,js,favoritePageController.AddingToList,statusInfo,inputGridPageURL, Homepage, inputAccountEmail, inputAccountPassword);
                            ...
                            favoritePageTest.checkingDeletingFromList(webDriver,report,js,favoritePageController.DeletingFromList,statusInfo,inputGridPageURL, Homepage, inputAccountEmail, inputAccountPassword);
